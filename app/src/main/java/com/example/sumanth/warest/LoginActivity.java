...
public class LoginActivity extends AppCompatActivity {
  ...
  private static final String TAG =LoginActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        redirect = (TextView)findViewById(R.id.signup_link);
        ...
        inputUSN = (EditText) findViewById(R.id.email);
      ...
      //  btnLinkToRegister = (Button) findViewById(R.id.btnLinkToRegisterScreen);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String username = inputUSN.getText().toString().trim();
                String password = inputPassword.getText().toString().trim();
                String user = spinner.getSelectedItem().toString().trim();
                ...
                if (!username.isEmpty() && !password.isEmpty() && !type.isEmpty()) {
                    // login user
                    Log.d("Android: ",username+password+type);
     ...
     * */
    private void checkLogin(final String username, final String password,final String type) {
